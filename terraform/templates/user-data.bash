...
install_syslog_ng_ubuntu() {
    ...
    sudo ln -s /usr/lib/jvm/java-21-openjdk-amd64/lib/server/libjvm.so /usr/lib/libjvm.so
    ...
    echo 'export LD_LIBRARY_PATH=$JAVA_HOME/lib/server' | sudo tee -a /etc/profile
    source /etc/profile
